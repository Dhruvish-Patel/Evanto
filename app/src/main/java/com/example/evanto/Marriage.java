        ...
        dateSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        Marriage.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//                    refrence.child("Marriage").setValue(details);
                    openDialogue();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            str = str + " "+email+" "+phoneNumber+" "+date+" "+loc+" "+guestsCount+" Marriage";
                            Intent intent = new Intent(Marriage.this,ConfirmBooking.class);
