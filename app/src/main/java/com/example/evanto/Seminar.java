...
public class Seminar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] options = {"Surat_Marriot_Hotel-Umra","CoutYard_by_Marriot-Hazira","Hotel_Orange_International-RailwayStation_Road","Hotel_Amisha_International-Una_Pani_Road","Lords_Plaza-DelhiGate_RingRoad", "Hotel_Sadbhav_Villa-Marvela_Business_Hub_RTO"};        ArrayAdapter adapter = new ArrayAdapter(Seminar.this,R.layout.dropdown_item,options);
        ...
        dateSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        Seminar.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//                    refrence.child("Corporate").setValue(details);
//                    Toast.makeText(Seminar.this,"SUCCESSFUL",Toast.LENGTH_LONG).show();
                    openDialogue();
                    final Handler handler = new Handler();
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            str = str +" "+email+" "+phoneNumber+" "+date+" "+loc+" "+guestsCount+" Corporate";
                            Intent intent = new Intent(Seminar.this,ConfirmBooking.class);
